...
public class AuctionControllerTests
{
    ...
    public AuctionControllerTests()
    {
        ...
        {
            mc.AddMaps(typeof(MappingProfles).Assembly);
    ...
    public async Task GetAuctions_WithNoParams_Return10Auctions()
    {
        ...
        _auctionRepo.Setup(repo => repo.GetAuctionDtosAsync(null)).ReturnsAsync(auctions);
    ...
    [Fact]
    public async Task UpdateAuction_WithUpdateAuctionDto_ReturnOkResponse()
    {
        ...
        Assert.IsType<AuctionDto>(updatedResult.Value);
    }

    [Fact]
    public async Task UpdateAuction_WithInvalidUser_Return403Forbid()
    {
        var auction = _fixture.Build<Auction>().Without(x => x.Item).Create();
        auction.Item = _fixture.Build<Item>().Without(x => x.Auction).Create();
        var updateDto = _fixture.Create<UpdateAuctionDto>();
    ...
    [Fact]
    public async Task UpdateAuction_WithInvalidGuid_ReturnNotFound()
    {
        var auction = _fixture.Build<Auction>().Without(x => x.Item).Create();
        auction.Item = _fixture.Build<Item>().Without(x => x.Auction).Create();
        var updateDto = _fixture.Create<UpdateAuctionDto>();
    ...
    [Fact]
    public async Task DeleteAuction_WithValidUser_ReturnOkResponse()
    {
        var auction = _fixture.Build<Auction>().Without(x => x.Item).Create();
        auction.Seller = "test";
        _auctionRepo.Setup(repo => repo.GetAuctionEntityById(It.IsAny<Guid>())).ReturnsAsync(auction);
    ...
    [Fact]
    public async Task DeleteAuction_WithInvalidGuid_ReturnNotFound()
    {
        var auction = _fixture.Build<Auction>().Without(x => x.Item).Create();
        auction.Seller = "test";
        _auctionRepo.Setup(repo => repo.GetAuctionEntityById(It.IsAny<Guid>())).ReturnsAsync(value: null);
    ...
    [Fact]
    public async Task DeleteAuction_WithInvalidUser_Return403Forbid()
    {
        var auction = _fixture.Build<Auction>().Without(x => x.Item).Create();
        auction.Seller = "not-test";
        _auctionRepo.Setup(repo => repo.GetAuctionEntityById(It.IsAny<Guid>())).ReturnsAsync(auction);
